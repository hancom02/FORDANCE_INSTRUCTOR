...
import { useAddSessionClass } from "../store/add_session_class_slice";

const AddSessionClassScreen = () => {
  const route = useRoute<RouteProp<{ params: { classData: IClass } }, 'params'>>();
  ...
  console.log('Class data:', classData);
    ...
    const {uuid} = useAuth();
    const {getClass, getEnumLevelValues, getEnumGenreValues, addSession} = useAddSessionClass();
            ...
            <ScrollView style={styles.scrollContainer}>
                ...
                <View style={styles.level_genre_container}>
                  ...
                  <View style={styles.level_container}>
                    ...
                    <Dropdown
                        style={[styles.dropdown, classData?.level !== 'mutigenre' && styles.disableColor, isFocusLevel && { borderColor: 'blue' }]}
                        placeholderStyle={styles.placeholderStyle}
                        selectedTextStyle={styles.selectedTextStyle}
                        inputSearchStyle={styles.inputSearchStyle}
                        iconStyle={styles.iconStyle}
                    ...
                    <View style={styles.genre_container}>
                      ...
                      <Dropdown
                          style={[styles.dropdown, classData?.genre !== 'mutigenre' && styles.disableColor,  isFocusGenre && { borderColor: 'blue' }]}
                          placeholderStyle={styles.placeholderStyle}
                          selectedTextStyle={styles.selectedTextStyle}
                          inputSearchStyle={styles.inputSearchStyle}
                          iconStyle={styles.iconStyle}
...
export default AddSessionClassScreen;
